...
else if(restMinuten<=vorlaufMinuten){console.log("restMinuten <= vorlaufMinuten::"+restMinuten+" <= "+vorlaufMinuten);if(currentLang==='it'){if(schlussZeit>regulaeresEnde){updateUI('#f39c12',`Ordinazione Takeaway tra ${startZeit} e ${regulaeresEnde}`+zusatzIt+`${schlussZeit}`);}
else{updateUI('#f39c12',`Ordinazione Takeaway tra ${startZeit} e ${regulaeresEnde}`);}}
else{if(schlussZeit>regulaeresEnde){updateUI('#f39c12',`Takeaway Bestellung von ${startZeit} -  ${regulaeresEnde}`+zusatz+` bis ${schlussZeit} Uhr`);}
else{updateUI('#f39c12',`Takeaway Bestellung von ${startZeit} -  ${regulaeresEnde}`);}}
...
else{console.log("Normalbetrieb");if(currentLang==='it'){if(schlussZeit>regulaeresEnde){updateUI('#2ecc71',`Ordinazione Takeaway tra ${startZeit} e ${regulaeresEnde}`+zusatzIt+`${schlussZeit}`);}
else{updateUI('#2ecc71',`Ordinazione Takeaway tra ${startZeit} e ${regulaeresEnde}`);}}
